...
def calculate_demographic_data(print_data=True):
    ...
    # Number of people who work the minimum hours
    num_min_workers = df[df['hours-per-week'] == min_work_hours]

    # Percentage of those who work minimum hours and earn >50K
    rich_percentage = round((num_min_workers['salary'] == '>50K').mean() * 100, 1)

    # Country with the highest percentage of people earning >50K
    rich_country = df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()
